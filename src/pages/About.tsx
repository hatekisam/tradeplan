                ...
                <div>
                        <div className='gap-[5vw] text-[1.05vw]  px-[7.5vw] py-[8vh]'>
                                ...
                                <div className='flex flex-row gap-[5vw] '>
                                        ...
                                        <div className='text-[1.05vw] font-medium text-[rgba(0,0,0,0.6)] w-[50%]'>
                                ...
                                <p className='my-[1.5vh]  text-[#191919] text-[1.05vw] text-center'>Unlock the potential of your trades – Act now and experience the <br /> transformative power of A.I.-driven second opinions!</p>
                                <p className='font-bold text-black text-[1.05vw] my-[1.5vh] text-center'>Invest in Your Success Today!</p>
                                <div className='flex items-center justify-center'>
                                        <button className='bg-[#FF6B00] px-[2vw] py-[1vh] rounded-full text-white my-[1vh]text-[1.0vw]'>Get started</button>
                                </div>
                                <div className="my-[5vh]">
                                        <p className="text-center text-[#FF6B00] font-bold text-[1.9vw]"><span className='text-[#0094FF]'>Our</span> CEO</p>
                                        <div className="my-[2vh] flex flex-row gap-[5vw]">
                                                <div className="w-[50%]">
                                                        <p className='font-bold text-[#00192C] text-[2.1vw] my-[1vh]'>Wayne McDonell</p>
                                                        <p className='my-[3vh] text-[#383838]'>Introducing the Future of Trading: A.I. Empowered Second Opinions!</p>
                                                        <p className='my-[3vh] text-[#383838]'>Wayne McDonell is a dynamic and visionary leader who has made a significant impact in the fields of entrepreneurship, venture capitalism, and finance, with a particular focus on AI-driven financial trading. His exceptional expertise, unwavering passion, and dedication to empowering individuals in the realm of AI trading have positioned him as a respected figure in the world of finance.<br />
                                                        ...
                                                        <p className='my-[3vh] text-[#0094FF]'>Read more</p>
