                        ...
                        <div className="w-full h-full bg-white rounded-[2vw] p-[2vw] overflow-y-auto">
                                <div>
                                        ...
                                        <div className="flex flex-row justify-between text-[2vw] md:text-[1.2vw]">
                                                ...
                                                <button className='hidde bg-[#0094FF] px-[2vw] py-[1vh] rounded-full h-fit text-white my-[1vh] flex flex-row gap-[0.5vw] items-center '>
                                                                ...
                                                                >
                                                                        ...
                                                                        <td className="p-2 ">
                                                                                <div className='bg-[rgba(225,0,0,0.06)] p-[.5vw] rounded-md'>
                                                                                        <svg xmlns="http://www.w3.org/2000/svg" width="21" height="20" viewBox="0 0 21 20" fill="none" className='w-[1.2vw]'>
