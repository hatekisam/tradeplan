...
const Sidebar = () => {
        return (
                <div className='hidden sm:flex w-fit md:w-[20vw] flex-col justify-between  bg-white h-full rounded-r-[2vw] p-[1vw] md:p-[2vw]'>
                        <div>
                                <div className="flex flex-row justify-between items-center">
                                        <div className="flex flex-row gap-2 items-center">
                                                <img src="/svg/logo.svg" alt="" className='w-[2.6vw]' />
                                                <p className='text-[#FF6B00] hidden md:block '>TradePlans<span className='text-[#0094FF]'>.AI</span></p>
                                        </div>
                                ...
                                <div className="my-[2vh] flex flex-col gap-[] text-[#858585] text-[1.05vw]">
                                        <Link to={"/home"} className='flex flex-row  items-center gap-[2vw] active:bg-[rgba(0,148,255,0.15)] hover:bg-[rgba(0,148,255,0.15)] hover:text-[#0094FF] hover:fill-[#0094FF] px-[1vw] py-1.5 rounded-md '>
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" className='w-[2vw] '>
                                                ...
                                                <p className='hidden md:block'>Activity</p>
                                        </Link>
                        ...
                        <Link to={"/home/profile"} className='flex flex-row gap-[3vw] bg-[rgba(255,107,0,0.13)]  px-[1vw] py-1.5 rounded-md  items-center'>
                                <img src="/image/steven.png" alt="" className='w-[2.5vw]' />
                                <p className='text-[#FF6B00] hidden md:block'>Steven</p>
                        </Link>
                </div>
        )
}
