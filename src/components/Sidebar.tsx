...
const Sidebar = () => {
        return (
                <div className='w-[20vw] flex flex-col justify-between bg-white h-full rounded-r-[2vw] p-[2vw]'>
                        <div>
                                ...
                                <div className="my-[2vh] flex flex-col gap-[1vh] text-[#858585] text-[1.05vw]">
                                        <Link to={"/home"} className='flex flex-row gap-5 active:bg-[rgba(0,148,255,0.15)] hover:bg-[rgba(0,148,255,0.15)] hover:text-[#0094FF] hover:fill-[#0094FF] px-[1vw] py-1.5 rounded-md '>
                                        ...
                                        <Link to={"/home/history"} className='flex flex-row gap-5 active:bg-[rgba(0,148,255,0.15)] hover:bg-[rgba(0,148,255,0.15)] hover:text-[#0094FF] hover:fill-[#0094FF] px-[1vw] py-1.5 rounded-md '>
                                                <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                                                ...
                                                <p className='hidden lg:block'>History</p>
                                        </Link>
                                </div>
                        </div>
                        <Link to={"/home/profile"} className='flex flex-row gap-5 bg-[rgba(255,107,0,0.13)]  px-[1vw] py-1.5 rounded-md  items-center'>
                                <img src="/image/steven.png" alt="" className='w-[2vws]' />
                                <p className='text-[#FF6B00]'>Steven</p>
                        </Link>
                </div>
        )
}
